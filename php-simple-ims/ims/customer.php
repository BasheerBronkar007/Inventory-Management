				...
				<div class="card-header">
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" align="right">
							<button type="button" name="add" id="addCustomer" data-bs-toggle="modal" data-bs-target="#userModal" class="btn btn-dark bg-gradient btn-sm rounded-0"><i class="far fa-plus-square"></i> New Departments</button>
						</div>
					</div>					   
        	...
        	<div class="modal-dialog modal-dialog-centered  rounded-0">
        			<div class="modal-content rounded-0">
						<div class="modal-header">
							<h4 class="modal-title"><i class="fa fa-plus"></i> Add Departments</h4>
						...
						<div class="modal-body">
							<div class="container-fluid">
								<form method="post" id="customerForm">
									...
									<div class="mb-3">
										<label class="control-label">Lab Incharge</label>
						...
						<div class="modal-footer">
							<button type="submit" name="action" id="action" class="btn btn-sm rounded-0 btn-dark" form="customerForm" >Save</button>
