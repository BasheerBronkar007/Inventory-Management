				...
				<div class="card-header">
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 text-end">
							<button type="button" name="add" id="addSupplier" data-bs-toggle="modal" data-bs-target="#userModal" class="btn btn-dark btn-sm rounded-0"><i class="far fa-plus-square"></i> Add Supplier</button>
						</div>
					</div>					   
        	...
        	<div class="modal-dialog modal-dialog-centered">
        			<div class="modal-content">
						...
						<div class="modal-footer">
							<input type="submit" name="action" id="action" class="btn btn-dark rounded-0 btn-sm" value="addSupplier" form="supplierForm"/>
