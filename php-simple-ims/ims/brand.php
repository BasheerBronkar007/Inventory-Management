                ...
                <div class="card-header">
                	<div class="row">
                		...
                		<div class="col-md-3 text-end">
                			<button type="button" name="add" id="addBrand" class="btn btn-dark bg-gradient btn-sm rounded-0"><i class="far fa-plus-square"></i> New items</button>
                		</div>
                	</div>
                </div>
                <div class="card-body">
    	...
    	<div class="modal-dialog modal-dialog-centered">
    			<div class="modal-content">
    				...
    				<div class="modal-footer">
    					<input type="submit" name="action" id="action" class="btn btn-dark btn-sm rounded-0" value="Add" form="brandForm"/>
