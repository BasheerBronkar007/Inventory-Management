...
<?php include('inc/container.php');?>
	...
	<h1 class="text-center my-4 py-3 text-light" id="title">Inventory Management System - AIKTC</h1>	
			...
			<div class="card-body">
				<div class="container-fluid">
					<form method="post" action="">
						...
						<div class="d-grid">
							<button type="submit" name="login" class="btn btn-dark rounded-0">Login</button>
						</div>
					</form>
				</div>
			</div>
