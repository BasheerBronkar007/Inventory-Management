                    ...
                    <div class="card-header">
                    	<div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 text-end">
                                <button type="button" name="addPurchase" id="addPurchase" class="btn btn-dark btn-sm rounded-0"><i class="far fa-plus-square"></i> Add Purchase</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <input type="submit" name="action" id="action" class="btn btn-dark btn-sm rounded-0" value="Add" form="purchaseForm"/>
